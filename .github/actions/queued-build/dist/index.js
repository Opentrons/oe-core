...
const orderedRepos = (/* unused pure expression or super */ null && (['monorepo', 'oe-core', 'ot3-firmware']));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        _actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput('queue-build', false);
    });
}
function _run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            _actions_core__WEBPACK_IMPORTED_MODULE_0__.setFailed(error.toString());
        }
    });
}
_run();
