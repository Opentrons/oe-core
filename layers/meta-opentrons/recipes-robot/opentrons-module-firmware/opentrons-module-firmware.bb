...
TEMPERATURE_MODULE_URL="temperature-module/modules-magdeck@v2.0.1-/tempdeck/${TEMPERATURE_MODULE_SOURCE}"
SRC_URI += "${BASE_URL}/${TEMPERATURE_MODULE_URL};sha256sum=44df799b54d5488a81727e36dad0cdc523ab8694f5d710d0a334abd774886d65"
