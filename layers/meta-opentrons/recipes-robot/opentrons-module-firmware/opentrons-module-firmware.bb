...
TEMPERATURE_MODULE_VERSION="v0.1.2"
...
SRC_URI += "${BASE_URL}/${TEMPERATURE_MODULE_URL};sha256sum=a5fc5749b8e71db5afb2ca4da46d023e2751f4a9c48dbecc2d2a9e1d85b984d3"

THERMOCYCLER-GEN2_MODULE_VERSION="v1.0.8"
...
SRC_URI += "${BASE_URL}/${THERMOCYCLER-GEN2_MODULE_URL};sha256sum=a5fc5749b8e71db5afb2ca4da46d023e2751f4a9c48dbecc2d2a9e1d85b984d3"
...
SRC_URI += "${BASE_URL}/${HEATER-SHAKER_MODULE_URL};sha256sum="cd025fb2bb1c354ede6039109dc10c2f204d52e18b9fd6f448727a18cf7560a1
