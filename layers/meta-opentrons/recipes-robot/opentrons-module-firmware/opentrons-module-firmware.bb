...
THERMOCYCLER-GEN2_MODULE_VERSION="v1.1.0"
...
SRC_URI += "${BASE_URL}/${THERMOCYCLER-GEN2_MODULE_URL};sha256sum=bc4a39e76f58bda81033fce70a252d5b1910d1a3b85fb845c00109cf314e1819"

HEATER-SHAKER_MODULE_VERSION="v1.1.0"
...
SRC_URI += "${BASE_URL}/${HEATER-SHAKER_MODULE_URL};sha256sum=ac6099a4c48aa77aeecaf74e605dbca7832596617ba333b9e5af219a3069ff85"
