...
THERMOCYCLER-GEN2_MODULE_VERSION="v1.1.2"
...
SRC_URI += "${BASE_URL}/${THERMOCYCLER-GEN2_MODULE_URL};sha256sum=4de0e77de87c0f515097e39d93e25b91495c5c53802c2a7ae8983c0f1e471bea"

HEATER-SHAKER_MODULE_VERSION="v1.1.5"
...
SRC_URI += "${BASE_URL}/${HEATER-SHAKER_MODULE_URL};sha256sum=e26ad3ce3bde898f0b23ea38f5b7af1148b3effbcf99c5234de8bae7f47eaff8"

FLEX-STACKER_MODULE_VERSION="v1.0.1"
...
SRC_URI += "${BASE_URL}/${VACUUM_MODULE_URL};sha256sum=ca3d474611835b5def0697e1745e713effe6cbceda456a914ae381495dfccf43"
